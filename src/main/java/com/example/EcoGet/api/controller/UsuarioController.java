...
import com.example.EcoGet.api.dto.CredenciaisDTO;
import com.example.EcoGet.api.dto.TokenDTO;
import com.example.EcoGet.api.dto.UsuarioDTO;
...
public class UsuarioController {
    ...
    public TokenDTO autenticar(@RequestBody CredenciaisDTO credenciais) {
        try {
            ...
            boolean admin = service.getUsuarioByEmail(credenciais.getEmail())
                    .map(Usuario::isAdmin).orElse(false);
            return new TokenDTO(usuario.getEmail(), token, admin);
